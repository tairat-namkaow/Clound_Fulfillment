...
WHERE detail.Detail_date BETWEEN ? AND ?
ORDER BY product.Product_id";
    ...
    if ($query_exp) {
        ...
        $header = array('Product_id', 'Product_name', 'Product_category', 'Out-Quantity', 'Shop_name', 'Warehouse_zone', 'Warehouse_Location', 'Order_address', 'Withdraw Date');
        fputcsv($file, $header);
